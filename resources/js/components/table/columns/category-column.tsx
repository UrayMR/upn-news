...
import { ICategoryIndex, StatusMap } from '@/types';
            ...
            return (
                <div className="flex items-center gap-2">
                    ...
                    <DeleteDialogButton
                        ...
                        description={`Apakah Anda yakin ingin menghapus kategori ${row.original.name}? Tindakan ini tidak dapat dibatalkan.`}
                        url={categories.destroy.url({
                            category: row.original.slug,
                        })}
                    />
                </div>
